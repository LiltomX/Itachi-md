...
generateReactionCommand("freeze", "🥶");
generateReactionCommand("angel", "😇");
generateReactionCommand("hot", "🥵");
generateReactionCommand("demon", "😈");
generateReactionCommand("clown", "🤡");
generateReactionCommand("virus", "🦠");
generateReactionCommand("bot", "🤖");
generateReactionCommand("tiger", "🐯");
generateReactionCommand("snake", "🐍");
